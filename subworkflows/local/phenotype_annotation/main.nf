...
workflow PHENOTYPE_ANNOTATION {
    ...
    //
    // MODULES: Run UniProtExtractR and rbioapi on extracted data
    //
    ...
    ch_uniprotr_results = ch_annotate_input.map { meta, _a, _t, _m -> [ meta, file('NO_FILE_uniprotr') ] }
    ...
    uniprotr_results = ch_uniprotr_results                       // [ meta, dir ]
