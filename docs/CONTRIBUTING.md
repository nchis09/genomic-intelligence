...
# `pgirl/genomic-intelligence`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving pgirl/genomic-intelligence.

This page describes the recommended nf-core way to contribute to both pgirl/genomic-intelligence and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of pgirl/genomic-intelligence.
...
- [ ] Check whether a GitHub [issue](https://github.com/pgirl/genomic-intelligence/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [pgirl/genomic-intelligence repository](https://github.com/pgirl/genomic-intelligence) to your GitHub account.
...
You can contribute to pgirl/genomic-intelligence without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/pgirl/genomic-intelligence/codespaces).
...
nf-core semi-standardises how you write code and other contributions to make the pgirl/genomic-intelligence code and processing logic more understandable for new contributors and to ensure quality.
