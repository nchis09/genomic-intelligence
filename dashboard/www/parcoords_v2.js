...
globalThis.parcoords_v2 = function(r2d3) {
  ...
  const rawWidth = (typeof r2d3.width === 'number' && r2d3.width > 0) ? r2d3.width : 960;
  const rawHeight = (typeof r2d3.height === 'number' && r2d3.height > 0) ? r2d3.height : 520;
